...
(function () {
  var bLazy = new (blazy__WEBPACK_IMPORTED_MODULE_0___default())();
})();

var bLazy = new (blazy__WEBPACK_IMPORTED_MODULE_0___default())({
  container: '.popup__all'
});
...
function scrollFunction() {
  if (document.body.scrollTop > h || document.documentElement.scrollTop > h) {
    gethdr.classList.add("activeheader");
  } else {
    gethdr.classList.remove("activeheader");
  }
}
...
window.onload = function () {
  window.replainSettings = {
    id: '81269575-79a9-4b89-b277-eb8fd4a93fa5'
  };
  setTimeout(function () {
    (function (u) {
  ...
  function go_online() {//grecaptcha.execute();
  }
  ...
  function popup_unchk() {
    ...
    setTimeout(function () {
      swiperblck.classList.remove("lock-swiper");
    }, 1500);
  }
